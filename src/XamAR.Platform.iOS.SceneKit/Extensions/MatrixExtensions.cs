...
namespace XamAR.Platform.iOS.SceneKit.Extensions
{
    public static class MatrixExtensions
    {
        ...
        public static Vector3 GetXAxis(this SCNMatrix4 m)
        {
            return new Vector3(m.M11, m.M12, m.M13);
        }

        public static Vector3 GetYAxis(this SCNMatrix4 m)
        {
            return new Vector3(m.M21, m.M22, m.M23);
        }

        public static Vector3 GetZAxis(this SCNMatrix4 m)
        {
            return new Vector3(m.M31, m.M32, m.M33);
        }

        public static Vector3 GetTranslation(this SCNMatrix4 m)
        {
